...
$fileErr = "";
?>
<p><b>Select your PNG picture :</b></p>
...
if ($_FILES["file"]["error"] > 0)
  ...
  // Allow png file formats
   ...
   $uploadOk = 0;
	 ...
	 $file = basename($_FILES["file"]["name"],".png").'.jpg';	

     $img = imagejpeg($im, $file);
...
echo '<div id="result">';
echo '<span class="error">* Sorry, only PNG files are allowed.'.$fileErr.'</span><br>';
echo '</div>';
}
?>
<p>&nbsp;</p>
