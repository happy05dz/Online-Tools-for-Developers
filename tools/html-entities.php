<h1>HTML Entity List</h1>
				...
				<p>Complete list of HTML entities with their numbers and names. Also included is a full list of ASCII characters that can be represented in HTML.</p>
				
				<ul>
					<li><a href="#ascii-characters">ASCII Characters</a></li>
					<li><a href="#iso88591-characters">ISO 8859-1 Characters</a></li>
					<li><a href="#iso88591-symbols">ISO 8859-1 Symbols</a></li>
					<li><a href="#math-symbols">Math Symbols</a></li>
					<li><a href="#greek-letters">Greek Letters</a></li>
					<li><a href="#misc-html-entities">Miscellaneous HTML entities</a></li>								
				</ul>

<div id="ascii-characters">
					<h2 style="margin:20px 0 10px 0">ASCII Characters</h2>
...
<div id="iso88591-characters">
					<h2 style="margin:20px 0 10px 0">ISO-8859-1 Characters</h2>
				...
				<div id="iso88591-symbols">
					<h2 style="margin:20px 0 10px 0">ISO-8859-1 Symbols</h2>
				...
				<div id="math-symbols">
					<h2 style="margin:20px 0 10px 0">Math Symbols</h2>
				...
				<div id="greek-letters">
					<h2 style="margin:20px 0 10px 0">Greek Letters</h2>
				...
				<div id="misc-html-entities">
					<h2 style="margin:20px 0 10px 0">Miscellaneous HTML entities</h2><p>List of miscellaneous HTML entities.</p><table class="bordered-table">
						<thead>
							<tr>
								<th nowrap="nowrap">Symbol</th>
								<th nowrap="nowrap">Entity Name</th>
