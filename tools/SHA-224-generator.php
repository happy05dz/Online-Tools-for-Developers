...
echo "<p><b>Computed SHA-224 digest :</b></p>";

if ($text <> ""){
  $SHA224 = hash('sha224', $text); 
 }

echo '<div id="result">';
echo '<form class="FormManagertools"><ul><li>';
echo '<textarea name="result" class="field-style">'.$SHA224.'</textarea></li></ul></form>';
echo '</div>';
?>
<p>&nbsp;</p>
